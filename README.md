...
```sh
timeout 8s quickshell --no-color -p "$HOME/.config/quickshell/main/shell.qml"
timeout 8s quickshell --no-color -p "$HOME/.config/quickshell/wallpaper/shell.qml"
timeout 8s quickshell --no-color -p "$HOME/.config/quickshell/HK-47_Avatar/shell.qml"
```
