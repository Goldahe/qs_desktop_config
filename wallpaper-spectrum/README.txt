...
START
  bash "$HOME/.config/quickshell/wallpaper-spectrum/start.sh"
...
STOP
  quickshell kill -p "$HOME/.config/quickshell/wallpaper-spectrum"
STATUS
  quickshell ipc -p "$HOME/.config/quickshell/wallpaper-spectrum" call spectrum status
RECONNECT AFTER CHANGING DEFAULT AUDIO OUTPUT
  quickshell ipc -p "$HOME/.config/quickshell/wallpaper-spectrum" call spectrum reconnect
