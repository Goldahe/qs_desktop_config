...
python ../main/avatar-control.py allowed shrine-maiden

# Ordinary avatar rendering belongs to the AMD display GPU. The RTX remains
# reserved for VFIO and explicitly approved AI workloads.
